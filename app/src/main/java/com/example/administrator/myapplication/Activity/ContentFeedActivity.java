...
public class ContentFeedActivity extends Activity {
    ...
    BaseAdapter adapter = new BaseAdapter() {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            if(view==null){
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.widget_commen_item, null);
            }
            ...
            public void onResponse(Call arg0, Response arg1) throws IOException {
                try{
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            ContentFeedActivity.this.reloadData(data);
                        }
                    });
                }catch(final Exception e){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ContentFeedActivity.this.onFailure(e);
                        }
                    });
                }
            }
            ...
            public void onResponse(Call arg0, Response arg1) throws IOException {
                try{
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            ContentFeedActivity.this.appendData(data);
                        }
                    });
                }catch(final Exception e){
                    runOnUiThread(new Runnable() {
